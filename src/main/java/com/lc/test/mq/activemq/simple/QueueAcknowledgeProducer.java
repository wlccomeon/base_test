...
/**
 * @Description: 消息生产者，开启手动签收模式的话，消费者必须手动签收。否则会导致重复消费问题。
 * @author: wlc
 * @date: 2019/6/27 0027 10:29
 **/
public class QueueAcknowledgeProducer {
	...
	public static void main(String[] args) throws JMSException {
		...
		connection.start();
		//第1个参数为是否支持事务，第2个参数为是否使用消息确认机制(这里选择的需要客户端手动签收)
		...
		for (int i = 1; i <= 6; i++) {
			...
			textMessage.setText("lc_acknowledge_mq_"+i);
			//生产者发送消息
